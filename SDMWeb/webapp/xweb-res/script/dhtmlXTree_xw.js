...
dhtmlXTreeObject.prototype.serializeTree=function(){
 var out='<?xml version="1.0" encoding="ISO-8859-1"?><tree id="0">';
 ...
 if(that.G_node)
{
 ...
 if(that.G_node)
 window.setTimeout(new function(){that.loadXML(that.XMLsource+getUrlSymbol(that.XMLsource)+"id="+that._escape(that.G_node.id));},100);
 else
