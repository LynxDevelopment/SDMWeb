 ...
 if((dhtmlObject.slowParse)&&(dhtmlObject.parsingOn==dhtmlObject.rootId))
{
 ...
 var nodelist=dhtmlObject.XMLLoader.doXPath("//item[@open]");
 else{
 var pnodelist=dhtmlObject.XMLLoader.xmlDoc.responseXML.getElementsByTagName("item");
...
dhtmlXTreeObject.prototype.moveItem=function(itemId,mode)
{
 var sNode=this._globalIdStorageFind(itemId);
 if(!sNode)return(0);
 switch(mode){
...
dhtmlXTreeObject.prototype.getRootId=function(){
	return this.rootId
}
