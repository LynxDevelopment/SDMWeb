...
insert into TB_FUNCTION_GROUPS (GROUP_ID, FUNCTION_ID, MODULE_ID) select 'XWEB_ADMIN', FUNCTION_ID, MODULE_ID from TB_FUNCTIONS where FUNCTION_ID<>'MONITOR' and MODULE_ID<>'TUNING';