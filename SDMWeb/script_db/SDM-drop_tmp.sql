    ...
    drop table SDM_PROCESSES cascade constraints;

    drop table SDM_PROCESSPROPERTIES cascade constraints;

    drop table SDM_TASKEXECUTIONS cascade constraints;

    drop table SDM_TASKS cascade constraints;
    ...
    drop sequence PROCESSPROPERTY_GEN;

    drop sequence PROCESS_GEN;
    ...
    drop sequence TASKEXECUTION_GEN;

    drop sequence TASK_GEN;
